<?php require APPROOT . '/views/inc/header.php'; ?>
    ...
    <?php if($_SESSION['user_type'] === 'support') { ?>
        <a href="<?php echo URLROOT; ?>" class="btn btn-light"><i class="fa fa-backward" aria-hidden="true"></i>Tickets Non Attribué</a>
        <div class="row mb-3">
            <div class="col-md-6">
                <h1>Tickets Attribué</h1>
            </div>
        </div>
        <?php foreach($data['ticketsBySupport'] as $ticket) { ?>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <a href="<?php echo URLROOT; ?>/tickets/add" class="btn btn-primary pull-right">
                    <i class="fa fa-pencil"></i> CREER UNE TICKETS
                </a>
            </div>
        </div>
        <?php foreach($data['ticketsByUser'] as $ticket) { ?>
            <div class="card card-body mb-3">
                <div class="row mb-2">    
                    <p class="d-flex flex-row col-md-10"><?php echo $ticket->ticketType; ?> - <?php echo $ticket->category; ?></p>    
                    <div class="d-flex flex-row col-md-10 mt-1">
